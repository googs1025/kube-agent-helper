...
import { useEventsPaginated } from "@/lib/api";
...
export default function EventsPage() {
  ...
  const { data, error, isLoading } = useEventsPaginated({
      ...
      <div className="mb-6 flex flex-wrap gap-4">
        <div className="flex flex-col gap-1">
          ...
          <input
            type="text"
            value={namespace}
            onChange={(e) => { setNamespace(e.target.value); table.setPage(1); }}
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            type="text"
            value={name}
            onChange={(e) => { setName(e.target.value); table.setPage(1); }}
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            value={since}
            onChange={(e) => { setSince(Number(e.target.value)); table.setPage(1); }}
